...
export async function createCardOportunidade (companyId, name, mensagem, garrafao_pp_20l ,garrafao_20l_azul, garrafao_10l, vendedor, tampa, tampa_pet, idForm) {
    ...
    const novoCardOportunidade = await fetch('https://api.pipefy.com/graphql',{
            ...
            body: JSON.stringify({
                          "query": `mutation{ createCard (input: {pipe_id:${pipeIdOportunidade}  phase_id:${phaseIdOportunidade}  fields_attributes: [
                              ...
                              {field_id: "vendedor", field_value: "${vendedor}"},
