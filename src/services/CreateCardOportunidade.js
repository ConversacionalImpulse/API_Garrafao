...
export async function createCardOportunidade (companyId, name, mensagem, garrafao_pp_20l ,garrafao_20l_azul, garrafao_10l, id_vendedor, tampa, tampa_pet, idForm) {
